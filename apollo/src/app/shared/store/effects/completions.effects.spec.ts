...
import { CompletionsFetcherService, CompletionsService } from "@apollo/shared/services";
...
describe('CompletionsEffects', () => {
   ...
   function completionsFetcherServiceFactory() {
      const service: jasmine.SpyObj<CompletionsFetcherService> = {
         ...jasmine.createSpyObj('CompletionsFetcherService', ['saveCompletions', 'clearGuestStorage']),
         getCompletionsForCurrentUser: () => of(userCompletions)
      };
