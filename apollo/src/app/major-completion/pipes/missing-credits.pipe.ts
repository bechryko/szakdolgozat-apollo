...
import { UniversityCompletionYear, UniversityMajorSubjectGroup, UniversitySpecialization, UniversitySpecializationSubjectGroup, UniversitySubjectCompletion } from '@apollo/shared/models';
...
export class MissingCreditsPipe implements PipeTransform {
   public transform(value: UniversityMajorSubjectGroup | UniversitySpecializationSubjectGroup | UniversitySpecialization, completions: UniversityCompletionYear[]): number {
